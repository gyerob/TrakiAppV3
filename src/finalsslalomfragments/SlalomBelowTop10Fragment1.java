...
public class SlalomBelowTop10Fragment1 extends Fragment implements IListViewUpdate {
	...
	public static SlalomBelowTop10Fragment1 newInstance() {
		SlalomBelowTop10Fragment1 fragment = new SlalomBelowTop10Fragment1();
	...
	class UpdateList extends AsyncTask<ToplistView, String, ToplistView> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(
					SlalomBelowTop10Fragment1.this.getActivity());
