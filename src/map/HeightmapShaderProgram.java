...
public class HeightmapShaderProgram extends ShaderProgram {
	...
	public HeightmapShaderProgram(Context context) {
		...
		uVectorToLightLocation = glGetUniformLocation(program,
				U_VECTOR_TO_LIGHT);
		...
		uPointLightPositionsLocation = glGetUniformLocation(program,
				U_POINT_LIGHT_POSITIONS);
		uPointLightColorsLocation = glGetUniformLocation(program,
	 ...
	 * glUniform3f(uVectorToLightLocation, vectorToLight.x, vectorToLight.y,
	 * vectorToLight.z); }
	 */
